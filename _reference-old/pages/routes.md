...
|  agency_id | Optional | The **agency_id** field defines an agency for the specified route. This value is referenced from the [agency.txt](/reference/agency) file. Use this field when you are providing data for routes from more than one agency. |
