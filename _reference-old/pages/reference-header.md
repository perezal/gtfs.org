...
* The first line of each file must contain field names. Each subsection of the Field Definitions corresponds to one of the files in a transit feed and lists the field names you may use in that file.
